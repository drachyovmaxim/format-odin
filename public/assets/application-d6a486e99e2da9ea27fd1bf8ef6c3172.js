...
(function() {
  $(function() {
    ...
    return $document.on('click', "#about-popup", function() {
      $p().css("display", "block");
    });
  });
...
(function() {
  $(function() {
    ...
    return $document.on('click', "#contacts-popup", function() {
      $p().css("display", "block");
    });
  });
...
(function() {
  ...
  $(function() {
    return $(".kalei").each(function() {
      var image, kaleidoscope, onMouseMoved, options, tr, tx, ty, update;
      image = new Image;
      ...
      image.src = $(this).attr('kaleimg');
      kaleidoscope = new Kaleidoscope({
        image: image,
        slices: 24,
        radius: $(this).height() * 1.1
      });
      ...
      this.appendChild(kaleidoscope.domElement);
      kaleidoscope;
...
(function() {
  $(document).ready(function() {
    return $(".prints").mousewheel(function(event, delta) {
      event.preventDefault();
